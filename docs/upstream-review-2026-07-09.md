...
一澜看到原作者 P0luz 的 upstream（现已到 v2.4.6 / v2.5.0）做了些升级，让我评估对我们有没有帮助、能不能顺手取长补短。结论：**绝大部分我们已经有了或明确不要，只有一处安全洞是我们真缺的、且是小活，已当场补上。** 其余 upstream 新东西都是大活，记录在这里，留到骨架层项目（第5、6步）收尾后再议。
