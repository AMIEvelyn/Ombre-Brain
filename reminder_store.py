...
class ReminderStore:
    """Standalone active reminders (照顾备忘), separate from memory buckets
    and embeddings. Replaces the old TodoStore-derived followup/todo
    mechanism: reminders are created directly (manually or by Lin Zhan via
    MCP), not derived from bucket ### followup/### todo sections."""
